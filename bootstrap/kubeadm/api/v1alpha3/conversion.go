...
func Convert_v1alpha4_KubeadmConfigSpec_To_v1alpha3_KubeadmConfigSpec(in *kubeadmbootstrapv1alpha4.KubeadmConfigSpec, out *KubeadmConfigSpec, s apiconversion.Scope) error { //nolint
	if err := autoConvert_v1alpha4_KubeadmConfigSpec_To_v1alpha3_KubeadmConfigSpec(in, out, s); err != nil {
		return err
	}

	// To make fuzzy tests pass. Conversion from v1alpha4 to v1alpha3 is actually lossy, as IgnitionConfig field
	// has been added in v1alpha4.
	in.IgnitionConfig = nil
